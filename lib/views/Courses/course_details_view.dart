...
import '../../widgets/courses/course_options_widget.dart';
...
class _CourseDetailsViewState extends State<CourseDetailsView> {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.network(
        'YOUR_VIDEO_URL_HERE'); // Replace 'YOUR_VIDEO_URL_HERE' with the actual video URL
                ...
                child: (state is CourseOptionStateChanges)
                  ...
                  onLectureChosen: (lecture) async {
                    try {
                      ...
                      print('Lecture chosen: ${lecture.title}');
                    } catch (e) {
                      FirebaseFirestore.instance
                          .collection('course_user_progress')
                          .doc(FirebaseAuth.instance.currentUser!.uid)
